...
|---|---|---|---|
| [CS01 LagrangeBench](01-lagrangebench.md) | TGV2D, Dam-break, Reverse Poiseuille | JAX, particle-based GNNs (GNS, SEGNN) | PH-SYM-001/002 fires on GNS, clean on SEGNN — equivariance gap detected on published checkpoints |
