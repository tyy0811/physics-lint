...
4. The v1.1 fix is ~1 day of calibration work (see `docs/backlog/v1.1.md` 2026-04-17 denominator regularization entry); holding v1.0 for it would be scope creep against the time-boxed release.
