...
(``particle_rollout_adapter.load_rollout_npz``), and reports the
load-bearing surface (velocity range, PBC audit fields, KE series,
harness defects). Codified version of the cross-rung contract
verification that surfaced the periodic-wraparound bug
(methodology/DECISIONS.md D0-17) and the
energy_drift-on-dissipative-systems methodology gap (D0-18) during
the rung-3.5 work.
