...
| 5 | Reproducibility section: Modal entrypoints, NGC checkpoint hash, git_sha, conda lockfile | ☑ | Task 7 (`5828980`) — Modal entrypoint table (7 entrypoints) + NGC checkpoint provenance (`ngc_version = latest`, `ckpt_sha256 = 0153803c8b2c0947948757a2298eec6ef21e8ea28131834963db08f34b4a0726`, `physicsnemo_sha = 1ca85d65ac2ce28ea9762910c09a954c08a37140`) + image-spec pin (no conda lockfile — modal_app.py builds the image; image-spec sha named); Finding-1 absorption (`a42784b`) corrected the Gate D inference-gate prose (D0-23 retired the original `10⁻³` max-abs criterion; RMSE-1 ≤ 5e-3 is the recalibrated band). |
